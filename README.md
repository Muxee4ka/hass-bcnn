...
- **Сенсоры счётчиков:** на каждый прибор учёта — текущие показания (м³, `state_class=total`) и «… — срок поверки» (DATE, диагностический, читается из таблицы кабинета как `MM/YY`).
